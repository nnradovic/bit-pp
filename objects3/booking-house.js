...
(function () {
    ...
    function BettingHouse(competition) {
        ...
        this.getData = function () {
            var firstLine = this.competition + ', ' + this.listOfBettingPlaces.length + ' betting places ' + this.numberOfPlayers;
            var secondLine = '';
    ...
    var address1 = new Address('Trinesti jul 15', '80000 Podgorica', montenegro);
    address.fullAddress(serbia);
    address1.fullAddress(montenegro);

    // console.log(address.fullAddress(montenegro));

    //Pravimo instancu igraca
    var player1 = new Player(nikola, 1200, serbia);
    var player2 = new Player(darko, 2000, montenegro);
